...
return [
    ...
    // 视图输出字符串内容替换
    'view_replace_str'       => [
        '__PUBLIC__' => '/' . (IS_PUBLIC ? '' : PUBLIC_NAME.'/'),
        '__STATIC__' => '/' . (IS_PUBLIC ? 'static/' : PUBLIC_NAME.'/static/'),        
    ],
    // 默认跳转页面对应的模板文件
    ...
    'captcha' => [
        // 验证码字符集合
        'codeSet' => '23568abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY',
        // 验证码字体大小(px)
        'fontSize' => 16,
        // 是否画混淆曲线
        'useCurve' => false,
