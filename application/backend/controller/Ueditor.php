...
class Ueditor extends BackendBase
{
    ...
    {   
        ...
        $imageMaxSize    = Config::get('upload.image_max_size');
        $videoMaxSize    = Config::get('upload.video_max_size');
        $fileMaxSize     = Config::get('upload.file_max_size');
        $imageAllowFiles = json_encode(Config::get('upload.image_allow_files'));
        $videoAllowFiles = json_encode(Config::get('upload.video_allow_files'));
        $fileAllowFiles  = json_encode(Config::get('upload.file_allow_files'));
        $imageCompressEnable = Config::get('upload.image_compress_enable') ? true : false;
        $imageCompressBorder = Config::get('upload.image_compress_border');
...
class Uploader
{
    ...
    private function getFilePath()
    {
        ...
        $rootPath = IS_PUBLIC ? ROOT_PATH . PUBLIC_NAME : ROOT_PATH;
